...
- **Экспортирован**: 2026-01-10T10:36:18.7396325
...
arr.patch(from, patch, replaced) // Заменить участок

### Поиск и проверка

arr.find(p) // Найти первый
...
arr.partition(p) // Разделить по условию
...
arr.permutations // Все перестановки

### Комбинирование

arr1 ++ arr2 // Конкатенация
...
arr.foreach(f) // Применить к каждому
...
### Операции для многомерных массивов 

matrix.transpose // Транспонировать
matrix.flatten // Развернуть в одномерный
