...
**Технологии:** Scala 3.3.1, SBT 1.9.7
...
Для работы с проектом используйте команды из [`prompts/agents/quick-commands.md`](prompts/agents/quick-commands.md):

- `@prompt-architect` - работа с промптами
- `@plan-manager` - работа с планами
- `@create-task` / `@start-task` / `@complete-task` - управление задачами

При активации роли или команды, обратитесь к соответствующим файлам документации для получения детальных инструкций.
...
При работе над кодом курса:
- Приоритизируйте читаемость и образовательную ценность
- Пишите понятные, хорошо прокомментированные примеры
